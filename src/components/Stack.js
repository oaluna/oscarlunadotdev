    ...
    <>
      <section className="section snap-start w-full h-[100vh] relative my-[24vh]">
        ...
        <div className="container  px-1 mx-auto">
          ...
          <div className="float-right inline-flex flex-row flex-wrap justify-evenly w-3/4 text-center">
            ...
            <div className="col-span-4 m-12">
              <div className="w-16 h-16 lg:h-32 lg:w-32 shadow-md hover:shadow-xl shadow-black/25 hover:shadow-black/50 bg-gradient-to-tr from-black to-gray-900 sm:translate-x-12 md:translate-x-0 rounded-full hover:scale-125 hover:animate-bounce transition-all ease-out cursor-pointer duration-200 flex flex-col flex-wrap items-center justify-center">
