...
export default function LayoutEvenColumnOne() {
  ...
  return (
    <section
      className="section transition sub-section  snap-start"
      id="contact"
    >
            ...
            <div className="container px-1 lg:px-6 m-auto">
              <div className="grid grid-cols-4 gap-0 lg:gap-6 md:grid-cols-8 lg:grid-cols-12">
                <div className="col-span-4 lg:col-span-6 my-0 lg:my-auto">
                  <h1 className="text-gray-100 mb-6 text-[10vh] lg:text-[10vh] text-center md:text-left">
                    Get In Touch
                  </h1>
                ...
                <div className="col-span-4 lg:col-span-6">
                  <div className="mb-10 h-24">
                    <div className="relative mt-6 mx-0 space-y-2">
                      <input
                        id="id-01"
                        type="email"
                        name="id-01"
