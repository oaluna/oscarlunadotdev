      ...
      <section className="section snap-start" id="contact">
        <div className="container  px-1 lg:px-6 py-24 lg:py-32 m-auto">
          <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
            <div className="col-span-4 md:col-span-8 lg:col-span-12 bg-gradient-to-br from-red-500 to-indigo-500/75 via-purple-500 rounded-xl p-8">
                ...
                <div className="grid grid-cols-4 gap-0 lg:gap-6 md:grid-cols-8 lg:grid-cols-12">
                  ...
                  <div className="col-span-4 lg:col-span-6">
                    <div className="mb-10 h-24">
                      <div className="relative mt-12 mx-0">
                        <input
                          id="id-01"
                          type="email"
                          name="id-01"
                          ...
                          value={state["id-01"]}
                          className="peer relative h-10 w-auto md:w-72 rounded-tl rounded-bl border border-slate-200 mr-0 text-sm text-slate-500 placeholder-transparent outline-none transition-all autofill:bg-white invalid:border-pink-500 invalid:text-pink-500 focus:border-emerald-500 focus:outline-none invalid:focus:border-pink-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:bg-slate-50 disabled:text-slate-400"
