...
const Experience = () => (
  <section className="section snap-start" id="experience">
    <div className="container  px-1 px-6 md:py-32 lg:py-0 m-auto">
      <div className="grid grid-cols-4 gap-8 md:grid-cols-8 lg:grid-cols-12">
        <div className="col-span-4 md:col-span-8 lg:col-span-12">
          <h1 className="sub_title md:text-[15vh] lg:text-[30vh] md:text-center lg:text-right uppercase text-slate-900">
            Work Experience
          </h1>
      ...
      <div className="flex md:flex-row lg:flex-col md:items-center lg:items-start lg:justify-center md:space-x-3 md:w/1/3 lg:w-2/5 justify-start md:mt-[10vh] lg:mt-[-55vh]">
          ...
          <div className="col-span-4">
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-blue-700 bg-blend-color-burn overflow-ellipsis">
                  {job.description}
                </p>
              </div>
            </div>
