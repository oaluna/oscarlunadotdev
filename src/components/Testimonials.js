        ...
        <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
          <Fade right>
            <div className="col-span-4 md:col-span-8 lg:col-span-12">
              <h1 className="uppercase text-[#bb2649] lg:text-[20vh] text-[10vh]">
                Testimonials
              </h1>
            ...
            <div className="relative p-6">
              <figure className="relative z-10">
                <blockquote className="p-6 text-2xl leading-relaxed">
                  <p>
                    <em>Strong work, and good ideas about how to proceed.</em>
                  </p>
                </blockquote>
                <figcaption className="flex items-center gap-4 p-6 pt-2 text-sm text-white">
