export default function Canvas() {
  return (
    <div>
      <canvas
        className="bg-cover absolute bottom-0 top-0 md:top-[-25vh] left-0 w-screen h-[100vh] transform origin-[0.08% 100%] skew-y-[-16deg] scale-[120%] border-none z-[-1] overflow-x-hidden"
        style={{
